...
import { P1, P2, P3, P4, P5, P6 } from "../cards/Protection"
import { useFlipAnimation } from "@/hooks/useFlipAnimation"
import { useAnimationCoordinator } from "@/hooks/useAnimationCoordinator"

gsap.registerPlugin(Flip, ScrollTrigger)

export default function ProtectionFlipAnimation() {
  ...
  const { requestStart, notifyComplete } = useAnimationCoordinator("protection")
    ...
    <div ref={containerRef} className="relative">
      ...
      {stage < 3 && (
        <div className="relative">
          ...
          >
            <P1 stageKey={stage === 1 ? "p1-init" : undefined} isActive={!isManual && stage === 1} />
          </div>
          <div
            ref={card2Ref}
            data-flip-id="card-2"
          ...
          >
            <P2 stageKey={stage === 2 ? "p2-init" : undefined} isActive={!isManual && stage === 2} />
          </div>
        </div>
      )}
      ...
      {stage >= 3 && (
        <div className="flex flex-col lg:flex-row items-start gap-[5px]">
          <div
            ...
            data-flip-id="card-2"
          >
            <P2 stageKey="p2-static-completed" isActive={false} />
          </div>
          ...
          <div className="relative flex items-stretch">
            ...
            >
              <P3 stageKey={stage === 3 ? "p3-init" : undefined} isActive={!isManual && stage === 3} />
            </div>
            <div
              ref={card4Ref}
              data-flip-id="card-4"
            ...
            >
              <P4 stageKey={stage === 4 ? "p4-init" : undefined} isActive={!isManual && stage === 4} />
            </div>
          </div>
          ...
          {stage >= 5 && (
            <div className="relative flex items-stretch">
              ...
              >
                <P5 stageKey={stage === 5 ? "p5-init" : undefined} isActive={!isManual && stage === 5} />
              </div>
              <div
                ref={card6Ref}
                data-flip-id="card-6"
              ...
              >
                <P6 stageKey={stage === 6 ? "p6-init" : undefined} isActive={!isManual && stage === 6} />
              </div>
            </div>
          )}
        </div>
